...
NURBSCurve.prototype.getPoint = function (t) {
	...
	if (Math.abs(hpoint.w - 1.0) > 0.00001) {

		// project to 3D space: (wx, wy, wz, w) -> (x, y, z, 1)
		//hpoint.divideScalar( hpoint.w ); -- replaced this by the following code

		hpoint.x = hpoint.x / hpoint.w;
		hpoint.y = hpoint.y / hpoint.w;
		hpoint.z = hpoint.z / hpoint.w;
		hpoint.w = 1.0
	}
